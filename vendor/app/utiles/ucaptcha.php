...
class UCaptcha
{
    ...
    var $word = '123456789abcdefghijkmnpqrstuvwxyz';
    var $length = 5;
    var $img_width = 160;
    var $img_height = 50;
    var $font_path = '';
    ...
    const CAPTCHA_SESSION = 'captchaCode';
    ...
    public static function generarCaptcha()
    {
        $captchaConfig = array(
            'img_width'  => '185',
            'img_height' => '50',
        ...
        $captcha = new UCaptcha($captchaConfig);
    ...
    public function createCaptcha(){
        ...
        $image_data = "data:image/jpg;base64," . base64_encode(ob_get_clean());
        //file_put_contents(IMAGEN_DIR ."/tmp/captcha.jpg", base64_decode($image_data));
        imagedestroy($im);//destroying image
        // ob_flush();
        /* Store captcha code into session */
        USession::removerSession(self::CAPTCHA_SESSION);
        USession::setSession(self::CAPTCHA_SESSION,$word);
    ...
    {
        return $value == USession::getSession(self::CAPTCHA_SESSION);
    }
