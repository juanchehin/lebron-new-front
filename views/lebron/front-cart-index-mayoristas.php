<div class="col-md-12">
    ...
    <h2 class="m_11"><?= $response_title ?: "Tu Compra - Mayoristas" ?></h2>
...
<?php else : ?>
    ...
    <div class="col-md-3 form-group">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body text-center">
                ...
                <form action="!FrontPaymentMayoristas/confirmarCheckout" id="frm-pagar">
                    ...
                    <div style="padding-left:20px;">
                        ...
                        <label for="retiroLocal" class="btn btn-default">
                            <input id="retiroLocal" value="conEnvio" type="radio" name="retiroLocal" required>
                            Con envio
                        </label>

                        <label for="retiroLocal" class="btn btn-default">
                            <input id="retiroLocal" value="retiroLocal" type="radio" name="retiroLocal" required>
                            Retiro en local
                        </label>
    ...
    <script>
        ...
        function get_items()
        {
            ...
            fetch("!FrontCartMayoristas/getItemsCart").then(function (rs) {
        ...
        document.getElementById('frm-pagar').onsubmit = function (event) {
            ...
            if ( total_compra < 80000 )

            {

                jdialog("<span class='text-danger'>Su compra debe superar los $80.000</span>");
