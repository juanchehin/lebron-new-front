...
class FrontArticulo extends FrontMain

{
...

    {
        ...
        $attr['cart'] = static::articuloOpcion($articulo);
    ...
    public static function articuloOpcion(Articulo $item)
        ...
        <form id="<?= $id ?>" <?= $data_attr ?> rel="<?= ($stock = floatval($item->cantidad_online)) ?>" autocomplete="off" onsubmit="return false">
            ...
            <div id="dv-actions" style="text-align: left;">
                ...
                <div class="buttons_class"> 
                    ...
                    <button type="button" rel="<?= $id ?>" name="1" onclick="comprar(this)">Comprar Ahora</button>

                    <button type="button" class="aa-button" rel="<?= $id ?>" onclick="comprar(this)">Agregar <i class="fa fa-cart-plus"></i></button>
        ...
        <div class="product-item" id="articulo-<?= $id ?>">
            ...
            <figure>
                ...
                <figcaption>
                    ...
                    <?= static::articuloOpcion($articulo); ?>
