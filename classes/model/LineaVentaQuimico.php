...
class LineaVentaQuimico extends MainModel

{

    protected $table = self::tablaLineaVentaQuimico;

    public $primaryKey = "idlinea_venta_quimico";

    const fkVenta = "id_venta_quimico";
